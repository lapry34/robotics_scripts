function tau = minimum_squared_inverse_inertia_weighted_torque_norm_solution(J,  J_dot, q_dot, M, r_ddot, n, tau_0)
    %Inputs:
    ...
    tau = M * pinv(J) * (x_ddot + J * M_inv *n);
    %tau = M * pinv(J) * x_ddot + n;
